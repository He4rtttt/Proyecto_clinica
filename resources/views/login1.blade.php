  ...
  <body>
    <main>
      <div class="container-fluid">
        <a href="index.html">
            <img src="img/index/logo.png" class="logo sobreponer esquinaIzquierda" alt="">
        </a>
                        ...
                        <div class="row">
                            <div class="col-lg-10 col-xl-7 mx-auto">
                                ...
                                <form>
                                    ...
                                    <div class="text-center d-flex justify-content-between mt-4"><p>¿No tiene una cuenta? <a href="{{ route('register1') }}" class="font-italic text-muted"> 
